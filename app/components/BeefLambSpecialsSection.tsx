...
const BeefLambSpecialsSection = () => {
  const t = useTranslations('BeefLambSpecials');
        ...
        <div className="flex flex-col-reverse lg:flex-row items-stretch">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center text-center px-6 md:px-12 lg:px-16 xl:px-24 py-8 md:py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center">
              ...
              <Link href="/menu#beef-lamb-specials" className="group flex items-center justify-center gap-2 bg-[#DAAF18] hover:bg-[#E04B51] text-zinc-900 hover:text-white border-transparent px-8 py-4 rounded-full font-bold text-lg transition-colors duration-300 shadow-md hover:shadow-lg hover:-translate-y-1">
...
export default BeefLambSpecialsSection;
