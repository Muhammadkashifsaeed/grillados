        ...
        <div className="flex flex-col lg:flex-row items-stretch justify-between gap-12 lg:gap-4 xl:gap-8">
            ...
            <div className="flex flex-col gap-6 md:gap-8 w-full mb-16">
              ...
              <div className="flex flex-col w-full">
                <div className="flex items-end w-full gap-2 sm:gap-3">
                  ...
                  <div className="grow mb-1" style={{ borderBottom: '2px dotted rgba(255,255,255,0.5)', minWidth: '20px' }}></div>
                ...
                <div className="flex items-end w-full gap-2 sm:gap-3 mt-2 md:mt-3">
                  ...
                  <div className="grow mb-1" style={{ borderBottom: '2px dotted rgba(255,255,255,0.3)', minWidth: '20px' }}></div>
          ...
          >
            ...
            <Image 
                ...
                width={1000}
              height={750}
                className="w-full h-auto rounded-xl lg:rounded-none object-contain object-center lg:object-right scale-100 lg:scale-100 lg:scale-110 drop-shadow-2xl"
