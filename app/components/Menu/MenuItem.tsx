  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex items-end w-full gap-1.5 sm:gap-2">
        <span className="text-white text-xs sm:text-sm md:text-base lg:text-lg font-normal whitespace-normal shrink">
          {name}
        </span>
        <div
          className="grow mb-1"
        ...
        />
        <span className="text-white text-xs sm:text-sm md:text-base lg:text-lg font-bold whitespace-nowrap">
          {price}
        </span>
      </div>
