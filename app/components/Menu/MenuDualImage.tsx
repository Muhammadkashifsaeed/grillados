  ...
  return (
    <>
      <motion.div
        ...
        className={`w-full flex flex-col md:flex-row items-center justify-end lg:pr-[80px] ${(mobileLeftImageSrc || mobileRightImageSrc) ? 'py-4 lg:pt-0 lg:pb-0' : 'py-0 lg:pt-0 lg:pb-0'}`}
      >
        {/* Desktop Left Image */}
