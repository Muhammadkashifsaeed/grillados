  ...
  return (
    <>
      <motion.div
        ...
        className={`w-full grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-12 items-center ${(mobileLeftImageSrc || mobileRightImageSrc) ? 'py-4 lg:pt-0 lg:pb-0' : 'py-0 lg:pt-0 lg:pb-0'}`}
      >
        {/* Desktop Left Image */}
        <div className="relative w-full h-[200px] sm:h-[250px] md:h-[350px] lg:h-[500px] xl:h-[600px] z-10 hidden md:block">
          <Image
            ...
            className="object-contain object-bottom md:object-bottom-left scale-[1.15] drop-shadow-2xl"
            priority
          />
        </div>
