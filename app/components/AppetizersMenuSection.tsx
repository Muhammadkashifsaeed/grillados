...
export const AppetizersMenuSection = () => {
  return (
    <section id="appetizers" className="relative w-full py-6 lg:py-8 bg-[#0a0a0a]">
      {/* 
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 md:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:items-start items-center justify-between gap-4 lg:gap-8 w-full lg:pr-[80px]">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="w-full lg:w-1/2 flex items-start justify-center lg:justify-end relative lg:min-h-[500px] pt-0 lg:pt-0 pb-0 lg:pb-16 mx-auto lg:mt-0 pr-12 md:pr-16 lg:pr-0"
          >
            {/* Desktop Image */}
            <Image
