    ...
    <div className="w-full relative overflow-hidden flex flex-col items-center justify-center bg-transparent mt-8 mb-12">
      <div className="w-full">
        ...
        <motion.div 
          ...
          className="relative bg-[#FAAE40] rounded-[2rem] p-6 sm:p-8 md:p-10 flex flex-col xl:flex-row items-center justify-between shadow-[0_15px_30px_rgba(0,0,0,0.4)] border-4 border-[#fff1aa]/30 w-full z-20"
        >
          ...
          {/* Left Content Area */}
          <div className="w-full xl:w-[60%] flex flex-col text-center xl:text-left mb-10 xl:mb-0 relative z-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-black font-['Outfit',sans-serif] uppercase leading-[1.1] mb-4 tracking-tight drop-shadow-sm">
              GET UP TO 20% OFF <br className="hidden md:block"/>On The Entire Menu.
            </h2>
            <p className="text-black/90 font-bold text-base sm:text-lg md:text-xl leading-relaxed max-w-3xl mx-auto xl:mx-0">
              Click on &apos;Get your Voucher Now&apos; and enjoy up to 20% off at all Grillados branches across Canada!
            </p>
          </div>

          {/* Right Action Area */}
          <div className="w-full xl:w-[40%] flex flex-row items-center justify-center xl:justify-end relative z-10 mt-6 xl:mt-0 gap-3 sm:gap-6">
             
             <button className="w-full max-w-[240px] sm:max-w-[280px] xl:max-w-[320px] bg-black text-white hover:bg-red-600 font-extrabold text-sm sm:text-base md:text-lg py-3 sm:py-4 px-4 sm:px-6 rounded-xl shadow-xl hover:-translate-y-1 hover:shadow-[0_15px_30px_rgba(220,38,38,0.4)] transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 active:scale-95 group border-2 border-black/10 shrink-0">
                <span className="text-xl sm:text-2xl group-hover:scale-110 group-hover:-rotate-12 transition-transform duration-300">🎟</span>
                <span className="tracking-wide uppercase text-center leading-tight">Get your Voucher Now</span>
             </button>
