    ...
    <main className="flex flex-col flex-1 min-h-screen bg-white relative overflow-hidden pb-24">
      ...
      <div className="relative z-10 w-full mx-auto px-6 md:px-12 lg:px-20 mt-8 md:mt-12">
        ...
        <div className="text-gray-700 space-y-10 leading-relaxed text-sm md:text-base">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">1. What is Personal Data?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">2. What information will Grillado's gather about me as Personal Data?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">3. When and how is my consent obtained?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">4. What does Grillado's policy on cookies entail?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">5. In what ways will Grillado's utilize my Personal Data?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">6. How does Grillado's handle publicly available Personal Data?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">7. Will Grillado's utilize my Personal Data for marketing purposes?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">8. What measures have been implemented to safeguard the security of my Personal Data?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">9. In what manner will Grillado’s retain and store my Personal Data?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">10. Will my Personal Data be disclosed to any other parties?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">11. Hyperlinks, sponsors from third parties, advertisers, and ad servers</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">12. Will my Personal Data be moved outside of the province where I reside?</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">13. Additional gathering, utilization, and disclosure of my Personal Data</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold mb-4 font-['Outfit',sans-serif] text-[#0a0a0a]">14. Changes to this Privacy Policy</h2>
