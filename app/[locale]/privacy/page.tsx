      ...
      <div className="relative z-10 w-full mx-auto px-6 md:px-12 lg:px-20 mt-8 md:mt-12">
        ...
        {locale === 'fr' ? (
          ...
          <div className="text-black space-y-10 font-['Poppins',sans-serif] text-[14px] leading-[23px] font-normal">
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">1. What is Personal Data?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">2. What information will Grillado's gather about me as Personal Data?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">3. When and how is my consent obtained?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">4. What does Grillado's policy on cookies entail?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">5. In what ways will Grillado's utilize my Personal Data?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">6. How does Grillado's handle publicly available Personal Data?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">7. Will Grillado's utilize my Personal Data for marketing purposes?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">8. What measures have been implemented to safeguard the security of my Personal Data?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">9. In what manner will Grillado’s retain and store my Personal Data?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">10. Will my Personal Data be disclosed to any other parties?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">11. Hyperlinks, sponsors from third parties, advertisers, and ad servers</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">12. Will my Personal Data be moved outside of the province where I reside?</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">13. Additional gathering, utilization, and disclosure of my Personal Data</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-[20px] leading-[26px]">14. Changes to this Privacy Policy</h2>
