      ...
      <div className="relative z-10 w-full mx-auto px-6 md:px-12 lg:px-20 mt-8 md:mt-12">
        ...
        {locale === 'fr' ? (
          ...
          <div className="text-black space-y-10 font-['Poppins',sans-serif] text-3.5 leading-5.75 font-normal">
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">License</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">Accessing</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">Behavior</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">Links to Internet Resources</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">User Suggestions</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">Intellectual Property</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">Warranty Disclaimer</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">Limited Liability</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">Indemnity</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">No Agency</h2>
            ...
            <section>
              <h2 className="mb-4 font-['Ribeat',sans-serif] font-semibold text-black text-5 leading-6.5">Accessibility</h2>
